...
```
claude plugin marketplace add kyolim/ecoai
```

### Plugin 설치

```
claude plugin install ecoai@kyolim
```

### 대화형 명령어로 설치

```
/plugin install ecoai@kyolim
```
...
```bash
# Plugin 업데이트
claude plugin update ecoai@kyolim

# 대화형 명령어
/plugin update ecoai@kyolim
```

## 제거

```bash
claude plugin uninstall ecoai@kyolim
```
