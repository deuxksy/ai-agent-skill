...
```
claude skill marketplace add kyolim/ecoai
```

### Git URL로 직접 설치

```
claude plugin add https://repository.kr/crong/ecoai.git
```

설치 후 Claude Code 재시작 시 Skill이 자동 로드됨.
