...
- **Project**: `zzizily` — Personal automation AI Agent Skill marketplace providing 9 domain plugins.
- **Repository**: `deuxksy/ai-agent-skill`
- **Unified Version**: `1.10.0`
- **Author**: Crong (kyolim)

## Versioning & Commit Convention

- **SemVer**: Follow Semantic Versioning (`1.10.0`). All plugin manifests (`.claude-plugin/marketplace.json`) and catalog tables must stay in sync.
